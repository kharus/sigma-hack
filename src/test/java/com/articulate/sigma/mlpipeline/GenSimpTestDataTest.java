...
public class GenSimpTestDataTest {
    ...
    @Test
    public void testTrespass() {
        testVerb("Trespassing", false, PRESENT, "trespass", false, "Trespasses", lfeat);
    }

    @Test
    public void testTrespass2() {
        testVerb("Trespassing", false, PROGRESSIVE, "trespass", false, "is trespassing", lfeat);
    }

    @Test
    public void testBuying() {
        testVerb("Buying", false, PRESENT, "buy", false, "Buys", lfeat);
    }

    @Test
    public void testBuying2() {
        testVerb("Buying", false, PAST, "buy", false, "Bought", lfeat);
    }

    @Test
    public void testWalking() {
        testVerb("Walking", false, PAST, "pad", false, "Padded", lfeat);
    }

    @Test
    public void testRequesting() {
        testVerb("Requesting", false, PRESENT, "wish", false, "Wishes", lfeat);
    }

    @Test
    public void testProcessYou() {
        lfeat.subj = "You";
    ...
    public void testLooking() {
        testVerb("Looking", false, PROGRESSIVE, "catch", false, "Is catching", lfeat);
    }
    ...
    public void testListening() {
        testVerb("Listening", false, PAST, "hear", false, "Heard", lfeat);
    }

    @Test
    public void testApologizing() {
        testVerb("Apologizing", false, PROGRESSIVE, "apologize", false, "Is apologizing", lfeat);
    }

    @Test
    public void testIntentional() {
        testVerb("IntentionalProcess", false, PAST, "proceed", false, "Proceeded", lfeat);
    }

    @Test
    public void testSeeing() {
        testVerb("Seeing", false, PRESENT, "watch", false, "Watches", lfeat);
    }

    @Test
    public void testBegin() {
        testVerb("Process", false, PROGRESSIVE, "begin", false, "Is beginning", lfeat);
    }

    @Test
    public void testBegun() {
        testVerb("Process", false, PAST, "begin", false, "Begun", lfeat);
    }

    @Test
    public void testDistill() {
        testVerb("Distilling", false, PRESENT, "distill", false, "Distills", lfeat);
    }

    @Test
    public void testPunching() {
        testVerb("Punching", false, PRESENT, "punch", false, "Punches", lfeat);
    }

    @Test
    public void testGame() {
        testVerb("Game", false, PRESENT, "play", false, "Plays", lfeat);
    }

    @Test
    public void testFreezing() {
        testVerb("Freezing", false, PAST, "freeze", false, "Froze", lfeat);
    }
    // TODO: need exception to make this "John has frozen" rather than "John frozen"

    @Test
    public void testDivide() {
        testVerb("Separating", false, NOTIME, "divide", true, "Divides", lfeat);
    }
    ...
    public void testHear() {
        testVerb("Hearing", false, PASTPROG, "hear", true, "were hearing", lfeat);
    }

    @Test
    public void testMelt() {
        testVerb("Melting", false, PASTPROG, "melt", true, "were melting", lfeat);
    }

    @Test
    public void testTaking() {
        testVerb("Driving", false, FUTURE, "take", true, "will take", lfeat);
    }

    @Test
    public void testWind() {
        testVerb("Wind", true, FUTURE, "blow", false, "will not blow", lfeat);
    }
