...
public class GenSimpTestData {
    ...
    public AVPair getQuantity(String term) {
        ...
        String english = String.format("%." + decimalPlaces + "f", val) + " " + unitEng + " ";
        String sumo = "(measure ?DO (MeasureFn " + val + " " + unit + ")) ";
    ...
    public void generateHumanSubject(StringBuffer english, StringBuffer prop,
        ...
        generateHuman(english, prop, (lfeat.attitude.equals("None") || lfeat.attitude.equals("says")) &&
                lfeat.modal.attribute.equals("None") && english.length() == 0, "?H", type, name, lfeat);
    ...
    public void generateVerb(boolean negated, StringBuffer english, StringBuffer prop,
        ...
        } else if (debug) System.out.println("Error in generateVerb(): bad format in frame: " + lfeat.framePart);
        ...
        if (lfeat.framePart != "" && lfeat.framePart.contains("somebody") || lfeat.framePart.contains("something")) {
            ...
            if (lfeat.polite) //lfeat.subj.equals("You") && !english.toString().startsWith("Please") && rand.nextBoolean())
                english.append("!");
                    ...
                    questionWord(english.substring(0, english.toString().indexOf(" "))))
                english.append("?");
            else
                english.append(".");
            ...
            if (KButilities.isValidFormula(kb, prop.toString())) {
                if (debug)
                    System.out.println("generateIndirectObject(): valid formula: " + Formula.textFormat(prop.toString()));
