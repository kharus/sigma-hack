...
public class SUMOtoTFAformITCase extends IntegrationTestBase {
    ...
    public void testParents() {
        ...
        System.out.println("SUMOtoTFAformITCase.testParents(): result:   " + result);
        String expectedRes = "! [V__X : $i] : (s__instance(V__X, s__Human) => s__parents__2In(V__X, $sum(1 ,1)))";
        System.out.println("SUMOtoTFAformITCase.testParents(): expected: " + expectedRes);
        if (expectedRes.equals(result))
    ...
    public void test1() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.test1(): ");
        Formula f = new Formula("(equal ?X (AdditionFn 1 2))");
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.test1(): " + result);
        String expectedRes = "! [V__X : $real] : (V__X = $sum(1.0 ,2.0))";
        System.out.println("SUMOtoTFAformITCase.test1(): expected: " + expectedRes);
        if (expectedRes.equals(result))
    ...
    public void test1_5() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.test1_5(): ");
        Formula f = new Formula("(equal ?X (SubtractionFn 2 1))");
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.test1_5(): " + result);
        String expectedRes = "! [V__X : $real] : (V__X = $difference(2.0 ,1.0))";
        System.out.println("SUMOtoTFAformITCase.test1_5(): expected: " + expectedRes);
        if (expectedRes.equals(result))
    ...
    public void test2() {
        ...
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.test2(): " + result);
        ...
        System.out.println("SUMOtoTFAformITCase.test2(): expected: " + expected);
    ...
    public void test3() {
        ...
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.test3(): " + result);
        ...
        System.out.println("SUMOtoTFAformITCase.test3(): expected: " + expected);
        if (expected.equals(result))
    ...
    public void test4() {
        ...
        String expected = "! [V__NUMBER1 : $i,V__NUMBER2 : $i] : " +
                ...
                "((equal(V__NUMBER1 ,V__NUMBER2) | greaterThan(V__NUMBER1 ,V__NUMBER2)) => " +
                "greaterThanOrEqualTo(V__NUMBER1 ,V__NUMBER2)))";
        System.out.println("SUMOtoTFAformITCase.test4(): expected: " + expected);
        if (expected.equals(result))
    ...
    public void test5() {
        ...
        System.out.println("SUMOtoTFAformITCase.test5(): result: " + result);
        String expected = "(=>\n" +
                "(measure ?QUAKE\n" +
                "(MeasureFn ?VALUE RichterMagnitude))\n" +
                "(equal (SignumFn ?VALUE) 1))";
        System.out.println("SUMOtoTFAformITCase.test5(): expected: " + expected);
        if (expected.equals(result))
    ...
    public void testFloorFn() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testFloorFn(): ");
        Formula f = new Formula("(<=> " +
                "(equal (RemainderFn ?NUMBER1 ?NUMBER2) ?NUMBER) " +
                "(equal (AdditionFn (MultiplicationFn (FloorFn (DivisionFn ?NUMBER1 ?NUMBER2)) ?NUMBER2) ?NUMBER) ?NUMBER1))");
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testFloorFn(): " + result);
        String expected = "! [V__NUMBER1 : $int,V__NUMBER2 : $int,V__NUMBER : $int] : " +
                "((s__RemainderFn__0In1In2InFn(V__NUMBER1, V__NUMBER2) = V__NUMBER " +
                "=> $sum($product($to_int($quotient_e(V__NUMBER1 ,V__NUMBER2)) ,V__NUMBER2) ,V__NUMBER) = " +
                "V__NUMBER1) & " +
    ...
    public void testNumericSubclass() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testSubclass(): ");
        Formula f = new Formula("(<=> (and (equal (AbsoluteValueFn ?NUMBER1) ?NUMBER2) " +
                "(instance ?NUMBER1 RealNumber) (instance ?NUMBER2 RealNumber)) " +
                "(or (and (instance ?NUMBER1 NonnegativeRealNumber) (equal ?NUMBER1 ?NUMBER2)) " +
                "(and (instance ?NUMBER1 NegativeRealNumber) (equal ?NUMBER2 (SubtractionFn 0 ?NUMBER1)))))");
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testNumericSubclass(): " + result);
        String expected = "! [V__NUMBER1 : $real,V__NUMBER2 : $real] : " +
                "((s__AbsoluteValueFn__0Re1ReFn(V__NUMBER1) = V__NUMBER2 => " +
                "(((s__SignumFn__0In1ReFn(V__NUMBER1) = 1 | " +
                "s__SignumFn__0In1ReFn(V__NUMBER1) = 0) & V__NUMBER1 = V__NUMBER2) | " +
    ...
    public void testElimUnitaryLogops() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testElimUnitaryLogops(): ");
        Formula f = new Formula("(<=> (and (equal (AbsoluteValueFn ?NUMBER1) ?NUMBER2)) " +
                "(or (and (instance ?NUMBER1 NonnegativeRealNumber) (equal ?NUMBER1 ?NUMBER2)) " +
                "(and (instance ?NUMBER1 NegativeRealNumber) (equal ?NUMBER2 (SubtractionFn 0 ?NUMBER1)))))");
        String result = SUMOtoTFAform.elimUnitaryLogops(f);
        System.out.println("SUMOtoTFAformITCase.testNElimUnitaryLogops(): " + result);
    ...
    public void testVariableArity() {
        ...
        //SUMOtoTFAform.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testVariableArity(): ");
        ...
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testVariableArity(): result: " + result);
    ...
    public void testVariableArity2() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testVariableArity2(): ");
        ...
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testVariableArity2(): actual: " + result);
    ...
    public void testPredVarArity() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testPredVarArity(): ");
        Formula f = new Formula("(<=>\n" +
                "  (and\n" +
        ...
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testPredVarArity(): actual: " + result);
    ...
    public void testRemoveNumInst() {
        ...
        //SUMOtoTFAform.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testRemoveNumInst(): ");
        String sf = "\n" +
                "(<=>\n" +
                "    (and\n" +
        ...
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testRemoveNumInst(): actual: " + result);
    ...
    public void testInstNum() {
        ...
        SUMOtoTFAform.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testInstNum(): ");
        String sf = "(=> " +
                "(and " +
        ...
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testInstNum(): actual: " + result);
    ...
    public void testTypeConflict() {
        ...
        //SUMOtoTFAform.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testTypeConflict(): ");
        ...
        System.out.println("SUMOtoTFAformITCase.testTypeConflict(): varmap: " + SUMOtoTFAform.varmap);
        if (inc)
    ...
    public void testTypeConflict2() {
        ...
        //SUMOtoTFAform.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testTypeConflict2(): ");
        ...
        System.out.println("SUMOtoTFAformITCase.testTypeConflict2(): result:   " + result);
        System.out.println("SUMOtoTFAformITCase.testTypeConflict2(): expected: " + expected);
    ...
    public void testTypeConflict3() {
        ...
        //SUMOtoTFAform.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testTypeConflict3(): ");
        String sf = "(forall (?X) (=> (instance ?X Table) (agent ?Y ?X)))";
        Formula f = new Formula(sf);
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        boolean inc = SUMOtoTFAform.inconsistentVarTypes();
        System.out.println("SUMOtoTFAformITCase.testTypeConflict3(): varmap: " + SUMOtoTFAform.varmap);
        if (inc)
    ...
    public void testTransNum() {
        ...
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testTransNum(): ");
        String sf = "(=> (instance ?X NegativeInteger) (greaterThan 0 ?X))";
        Formula f = new Formula(sf);
        System.out.println("formula: " + f);
        String result = SUMOtoTFAform.process(f, false);
        System.out.println("SUMOtoTFAformITCase.testTransNum(): result: " + result);
    ...
    public void testPropertyFn() {
        ...
        //FormulaPreprocessor.debug = true;
        System.out.println();
        System.out.println("\n======================== SUMOtoTFAformITCase.testPropertyFn(): ");
        ...
        System.out.println("SUMOtoTFAformITCase.testPropertyFn(): result:   " + result);
        System.out.println("SUMOtoTFAformITCase.testPropertyFn(): expected: " + expected);
        if (expected.equals(result))
