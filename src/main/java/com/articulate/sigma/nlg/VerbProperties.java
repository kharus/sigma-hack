...
public interface VerbProperties {
     ...
     * @param verb     the verb in infinitive form
     * @param caseRole
     * @return the strings most likely to be used for this verb and case role, where empty string means "no preposition"
     */
    List<String> getPrepositionForCaseRole(String verb, CaseRole caseRole);
