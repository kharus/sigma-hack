...
public class HTMLformatter {
    ...
    public static String showLanguageStats(KB kb, String lang) {
        ...
        String show = "<tr><td>termFormats: </td><td align=right>" + KButilities.getCountTermFormats(kb, lang) + "</td></tr>\n" +
                "<tr><td>unique terms in termFormats: </td><td align=right> " + KButilities.getCountUniqueTermFormats(kb, lang) + "</td></tr>\n" +
                "</table><p>\n";
        return show;
    }
    ...
    public static String showNeighborTerms(KB kb, String nonRelTerm, String relTerm) {
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                ...
                String nonRelation = nonRelations.get(i);
    ...
    public static String formatFormulaList(List<Formula> forms, String header, KB kb,
        ...
        boolean traditionalLogic = flang.equals("traditionalLogic");
        StringBuilder show = new StringBuilder();
        ...
        for (int i = start; i < localLimit; i++) {
            ...
            Formula f = kb.formulaMap.get(strForm);
            if (f == null) {
    ...
    /**
     * Create an HTML menu, given an List of Strings where the
    ...
    /**
     * Create an HTML menu, given an List of Strings.
     */
    ...
    /**
     * Create an HTML menu with an ID, given an List of
    ...
    public static String createMultiMenu(String menuName, TreeMap<String, String> options) {
        ...
        if (options == null)
            return "";
        result.append(options.keySet().size() + ">\n  ");
    ...
    /**
     * Create an HTML menu with an ID, given an List of Strings.
     */
                ...
                if (res != null) {
                    ...
                    for (int i = 0; i < subElements.size(); i++) {
                        ...
                        if (item.tagname.equals("kb"))
                            ...
                            List entries = ((BasicXMLelement) subElements.get(i)).subelements;
                            ...
                            if (page == 0) {
                                ...
                                for (int j = 0; j < entries.size(); j++) {
                                    List entry = ((BasicXMLelement) entries.get(j)).subelements;
                                    String query = null;
                                    String type = null;
                                ...
                                int j = page - 1;
                                List<BasicXMLelement> entry = ((BasicXMLelement) entries.get(j)).subelements;
                                String query = null;
                                String type = null;
                                ...
                                String sourceFile = null;
                                for (int k = 0; k < entry.size(); k++) {
                                    BasicXMLelement entryItem = entry.get(k);
                                    if (entryItem.tagname.equals("query"))
                                        query = entryItem.contents;
                                    else if (entryItem.tagname.equals("type"))
                                        type = entryItem.contents;
