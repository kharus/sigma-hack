...
public class ProofStep {
    ...
    public static ArrayList<ProofStep> removeDuplicates(ArrayList<ProofStep> proofSteps) {
        ...
        for (int i = 0; i < proofSteps.size(); i++) {
            ...
            if (formulaMap.containsKey(s) && ps.premises.size() == 1) {   // If the step is a duplicate, relate the current step number
        ...
        for (int i = 0; i < dedupedProofSteps.size(); i++) {
            ...
            Integer newIndex = ps.number;
            if (numberingMap.containsKey(newIndex))
        ...
        if (inferenceType.startsWith("kb_")) {
            ...
            if (originalF != null) {
                ...
                if (originalF.derivation != null &&
                    ...
                    sb.append(originalF.derivation);
            } else
