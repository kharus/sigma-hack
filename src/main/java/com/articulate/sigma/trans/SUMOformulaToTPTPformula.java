...
public class SUMOformulaToTPTPformula {
    ...
    private static String translateWord_1(String st, int type, boolean hasArguments) {
        ...
        if (debug)
            System.out.println("INFO in SUMOformulaToTPTPformula.translateWord_1(): hasArguments: " + hasArguments);
        int translateIndex;
    ...
    public static String processRecurse(Formula f) {
        ...
        if (Formula.isLogicalOperator(car.getFormula()))
            ...
            if (debug)
                System.out.println("SUMOformulaToTPTPformula.processRecurse(): not math or comparison op: " + car);
    ...
    public static String tptpParseSUOKIFString(String suoString, boolean query) {
        ...
        if (debug)
            System.out.println("SUMOformulaToTPTPformula.process(): string,query,lang: " + suoString + ", " + query + ", " + SUMOKBtoTPTPKB.lang);
    ...
    public void tptpParse(Formula input, boolean query, KB kb, Set<Formula> preProcessedForms)
        ...
        if (query || debug)
            System.out.println("INFO in SUMOformulaToTPTPformula.tptpParse(): result: " + _f.theTptpFormulas);
    }
